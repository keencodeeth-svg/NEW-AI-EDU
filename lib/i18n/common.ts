export const commonZhCN = {
  ...
  toolbar: {
    ...
    pdfUpload: '上传 PDF',
    removePdf: '移除文件',
    generationModeStandard: '标准',
    generationModeDeep: '深交互',
    generationModeDeepHint: '优先生成更高比例的交互式场景与结构化 widget',
    webSearchOn: '已开启',
    webSearchOff: '点击开启',
...
export const commonEnUS = {
  ...
  toolbar: {
    ...
    generationModeStandard: 'Standard',
    generationModeDeep: 'Deep Interactive',
    generationModeDeepHint: 'Prefer a more interactive-first course structure with richer widgets',
    webSearchOn: 'Enabled',
