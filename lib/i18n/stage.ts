export const stageZhCN = {
  ...
  roundtable: {
    ...
    openChat: '展开讨论区',
    closeChat: '收起讨论区',
    enterImmersive: '进入沉浸播放',
    exitImmersive: '退出沉浸播放',
    immersiveBlocked: '请先结束当前互动，再进入沉浸播放',
    tools: '课堂工具',
    toolsHint: '音量、倍速、连播与白板',
    narration: '课堂播报',
    narrationOn: '开启播报',
    narrationOff: '关闭播报',
    volume: '播报音量',
...
export const stageEnUS = {
  ...
  roundtable: {
    ...
    play: 'Play lesson',
    pause: 'Pause lesson',
    previousScene: 'Previous page',
    nextScene: 'Next page',
    openSidebar: 'Open outline',
    closeSidebar: 'Close outline',
    openChat: 'Open discussion panel',
    closeChat: 'Close discussion panel',
    enterImmersive: 'Enter immersive mode',
    exitImmersive: 'Exit immersive mode',
    immersiveBlocked: 'Finish the current interaction before entering immersive mode',
    tools: 'Classroom tools',
    toolsHint: 'Volume, speed, auto-play, and whiteboard',
    narration: 'Narration',
    narrationOn: 'Enable narration',
    narrationOff: 'Mute narration',
    volume: 'Narration volume',
    learningRhythm: 'Learning pace',
    statusOn: 'On',
    statusOff: 'Off',
  },
  pbl: {
