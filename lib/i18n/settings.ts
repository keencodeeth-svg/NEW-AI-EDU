export const settingsZhCN = {
  settings: {
    ...
    agentDescriptions: {
      'default-1': '课堂主讲身份，负责搭建主线、组织讲解与节奏推进',
      'default-2': '课堂协同身份，负责补充解释、追踪理解与辅助收口',
      'default-3': '代表全班快速反馈，帮助老师判断课堂是否跟上',
      'default-4': '持续发起关键追问，推动概念真正被讲透',
      'default-5': '整理主线和重点，让课堂信息更清晰可回收',
      'default-6': '把知识往迁移和应用层推进，帮助课堂更有深度',
    },
    close: '关闭',
    save: '保存',
    // Provider settings
...
export const settingsEnUS = {
  settings: {
    ...
    required: 'Required',
    agentNames: {
      'default-1': 'Lead Mentor',
      'default-2': 'Class Assistant',
      'default-3': 'Class Spokesperson',
      'default-4': 'Question Driver',
      'default-5': 'Structure Recorder',
      'default-6': 'Transfer Thinker',
    },
    agentRoles: {
      teacher: 'Teacher',
      assistant: 'Assistant',
    ...
    agentDescriptions: {
      'default-1': 'Leads the lesson with structure, clarity, and teaching rhythm',
      'default-2': 'Supports the lesson with clarification and learning scaffolds',
      'default-3': 'Represents the classroom’s immediate reaction and feedback',
      'default-4': 'Pushes the lesson deeper through concise follow-up questions',
      'default-5': 'Organizes key ideas and keeps the lesson easy to review',
      'default-6': 'Extends ideas toward transfer, application, and deeper thinking',
    },
    close: 'Close',
    save: 'Save',
    // Provider settings
