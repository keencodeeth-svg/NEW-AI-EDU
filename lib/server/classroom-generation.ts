...
import type { ClassroomAccessActor } from '@/lib/server/classroom-storage';
import {
...
export async function generateClassroom(
  ...
  options: {
    baseUrl: string;
    owner?: ClassroomAccessActor | null;
  ...
  if (input.enableTTS) {
    ...
    try {
      await generateTTSForClassroom(scenes, stageId, options.baseUrl, stage.classroomMeta);
