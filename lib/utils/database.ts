...
/**
 * Interactive classroom local database.
 *
 * Uses IndexedDB to store classroom data locally.
...
const DATABASE_NAME = 'Hangke-Interactive-Classroom-Database';
const _DATABASE_VERSION = 8;

/**
 * Interactive classroom database instance.
 */
class InteractiveClassroomDatabase extends Dexie {
  // Table definitions
...
export const db = new InteractiveClassroomDatabase();
