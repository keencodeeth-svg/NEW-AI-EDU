export const PLATFORM_BRAND_NAME = "航科教育";
export const PLATFORM_PRODUCT_NAME = "航科 AI 教育平台";
export const PLATFORM_BRAND_SUBTITLE = "Learning Operating System";
export const PLATFORM_BRAND_TAGLINE = "让学习、教学与陪伴，都有清晰下一步。";
export const CLASSROOM_PRODUCT_NAME = "航科互动课堂";
...
export const PRODUCT_SERVICE_NAME = "hangke-classroom";
