...
function StreamingOutlineVisualizer({ outlines }: { outlines: SceneOutline[] }) {
  ...
  return (
    <div className="w-40 h-52 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-2xl p-4 overflow-hidden relative rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
      <div className="absolute top-0 inset-x-0 h-1 bg-sky-500/50" />
          ...
          allLines.map((line, i) => (
            <motion.div
              ...
              className={cn(
                'truncate',
                !line.startsWith('   ')
                  ? 'text-sky-600 dark:text-sky-400 font-semibold text-[9px]'
                  : 'pl-1 opacity-80',
              )}
            >
              {line}
    ...
    <div className="w-60 h-40 mx-auto flex items-center justify-center">
      <div className="flex gap-3">
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-14 h-20 rounded-lg bg-gradient-to-br from-sky-400 to-cyan-500 dark:from-sky-600 dark:to-cyan-700 shadow-lg shadow-sky-500/15"
    ...
    switch (idx) {
      case 0:
        return {
          ...
          label: 'SLIDE',
          badge:
            'bg-sky-100 text-sky-600 border-sky-200 dark:bg-sky-900/40 dark:text-sky-300 dark:border-sky-800',
        };
      case 1:
        return {
          color: 'cyan',
      ...
      {[0, 1].map((i) => (
        <motion.div
          ...
          className={cn(
            ...
            theme.color === 'sky' && 'border-sky-500/10',
        ...
        <AnimatePresence mode="popLayout">
          <motion.div
            ...
            className={cn(
              ...
              theme.color === 'sky' && 'border-sky-200 dark:border-sky-900/30',
            ...
            {index === 0 && (
              <div className="flex flex-col h-full pt-1">
                <motion.div
                  ...
                  className="h-2 bg-sky-500/20 rounded-full mb-3 shrink-0"
                />
                <div className="flex gap-2 flex-1">
                  ...
                  <motion.div
                    ...
                    className="w-12 h-12 bg-sky-50 dark:bg-sky-900/20 rounded-lg flex items-center justify-center shrink-0"
                  >
                    <BarChart3 className="size-6 text-sky-500/60" />
                  </motion.div>
                </div>
              </div>
            )}
