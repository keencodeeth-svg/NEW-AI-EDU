...
面向 K12 教学场景的互动课堂工作区，现已深度融入“知序学习平台”。它不只是一个课件生成器，而是一套把教务角色、教学资料、教师数字人、课堂演示、全班观看和课后导出串成闭环的教学产品能力。

## 项目定位

知序课堂解决的是“从教学准备到课堂交付”的完整链路：
...
- 按 `docs/p0-p2-full-score-optimization-roadmap.md` 追踪 P0/P1/P2 满分指标，把每轮优化落实到分数、验收命令和截图证据
- 课堂交付记录与班级分发台账
- 学校侧归档与教研协同
- 资源包导出后的继续编辑与回流
- 学生自主课堂与成长画像的更深联动
...
本仓库当前以“知序学习平台”主项目为基础，互动课堂能力已经完成一体化协同。后续产品、技术和 UI/UX 优化都围绕统一品牌、统一角色模型和统一后台能力继续演进。
