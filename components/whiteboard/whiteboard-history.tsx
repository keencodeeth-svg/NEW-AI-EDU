    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute top-14 right-4 z-[130] w-72 max-h-80 bg-white/98 dark:bg-slate-900/96 rounded-xl shadow-2xl border border-sky-100 dark:border-sky-900/40 overflow-hidden flex flex-col"
        >
          {/* Header */}
