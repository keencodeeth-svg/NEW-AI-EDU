...
function QuizCover({
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 px-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-br from-sky-100 via-cyan-50 to-white dark:from-sky-900/50 dark:via-cyan-900/30 dark:to-slate-900 rounded-2xl flex items-center justify-center shadow-lg shadow-sky-100/80 dark:shadow-sky-900/20 ring-1 ring-sky-200/60 dark:ring-sky-700/50"
      >
      ...
      >
        <div className="flex items-center gap-2 rounded-xl border border-sky-100 bg-white/80 px-3 py-2 text-gray-500 shadow-sm shadow-sky-100/60 backdrop-blur dark:border-sky-900/40 dark:bg-slate-900/60 dark:text-gray-400 dark:shadow-sky-950/10">
        ...
        <div className="flex items-center gap-2 rounded-xl border border-amber-100 bg-white/80 px-3 py-2 text-gray-500 shadow-sm shadow-amber-100/60 backdrop-blur dark:border-amber-900/40 dark:bg-slate-900/60 dark:text-gray-400 dark:shadow-amber-950/10">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-sky-500 via-cyan-500 to-blue-500 text-white rounded-full font-medium shadow-lg shadow-sky-200/60 dark:shadow-sky-900/40 hover:shadow-sky-300/60 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-gray-200 dark:border-gray-600 hover:border-sky-200 dark:hover:border-sky-700 hover:bg-sky-50/70 dark:hover:bg-sky-900/20',
                !isReview &&
                  selected &&
                  'border-sky-400 bg-sky-50 dark:bg-sky-900/20 ring-1 ring-sky-200 dark:ring-sky-700',
                // Review states
                isReview &&
                  isCorrectOpt &&
    ...
    <QuestionCard question={question} index={index} result={result}>
      {!isReview ? (
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-sky-50 dark:bg-sky-900/20 border border-sky-100 dark:border-sky-800">
...
export function QuizView({ questions, sceneId }: QuizViewProps) {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-b from-slate-50 via-sky-50/60 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden flex flex-col">
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-sky-500 via-cyan-500 to-blue-500 text-white shadow-sm hover:shadow-md hover:shadow-sky-200/60 dark:hover:shadow-sky-900/40 active:scale-[0.97]'
