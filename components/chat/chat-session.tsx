...
const AVATARS = {
  teacher: '/avatars/hangke-mentor.svg',
  user: '/avatars/hangke-learner.svg',
};
      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-sky-400/70 dark:bg-sky-500/70'
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'rounded-tr-sm bg-gradient-to-br from-sky-600 to-blue-700 text-white shadow-sm shadow-sky-300/30 ring-1 ring-sky-500/20 dark:from-sky-500 dark:to-blue-600 dark:shadow-sky-900/40'
          : isTeacher
          ...
          return (
            <motion.div
                ...
                isActiveBubble
                  ? {
                      ...
                      boxShadow: [
                        ...
                        '0 0 20px 0 rgba(14, 165, 233, 0.14)',
                        '0 0 8px 0 rgba(14, 165, 233, 0.08)',
                      ],
                    }
                  : {
                      opacity: 1,
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-sky-500 dark:border-l-sky-400 bg-sky-50/50 dark:bg-sky-950/20',
              )}
            >
              {/* Mini Avatar */}
