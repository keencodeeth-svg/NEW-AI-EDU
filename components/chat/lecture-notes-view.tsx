  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-50 text-sky-300 ring-1 ring-sky-100 dark:bg-sky-950/20 dark:text-sky-500 dark:ring-sky-900/30">
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isCurrent
                ? 'bg-sky-50/80 dark:bg-sky-950/25 ring-1 ring-sky-200/60 dark:ring-sky-800/30'
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <div
                className={cn(
                  ...
                  isCurrent
                    ? 'bg-sky-500 dark:bg-sky-400 shadow-sm shadow-sky-400/40'
              ...
              {isCurrent && (
                <span className="rounded-full bg-sky-100 px-1.5 py-px text-[9px] font-bold text-sky-600 dark:bg-sky-900/40 dark:text-sky-300">
