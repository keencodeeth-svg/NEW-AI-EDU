...
export function GenerationToolbar({
  ...
  // ─── Pill button helper ─────────────────────────────
  const pillCls =
    'inline-flex items-center gap-1.5 rounded-full px-2 py-1 text-[11px] font-medium transition-all cursor-pointer select-none whitespace-nowrap border';
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-sky-50/70 dark:bg-sky-950/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img
